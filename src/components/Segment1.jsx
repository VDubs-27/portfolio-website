    ...
    return (
        <div className="segment1">
            <div className="segment1-content">
                ...
                <button className="projects-button" onClick={(e) => handleScroll(e, "projects")}>View Projects</button>
                <button className="contact-button" onClick={(e) => handleScroll(e, "contact")}>Contact Me</button>
                <button className="resume-button" onClick={() => window.open("https://drive.google.com/file/d/1lxd5_QUTBv7C9NAuPfiNbJFf_AhZYAp8/view?usp=drive_link", "_blank")}>View Resume</button>
